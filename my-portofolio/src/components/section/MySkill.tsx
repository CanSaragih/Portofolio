...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex size-16 md:size-20 lg:size-24 items-center justify-center rounded-full border-2 bg-white p-4 md:p-5 lg:p-6 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function MySkills() {
  ...
  return (
    <div
      className="relative bg-transparent flex h-[600px] md:h-[700px] lg:h-[900px] w-full items-center justify-center overflow-hidden px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto"
      ref={containerRef}
    >
      <div className="flex size-full max-h-[400px] md:max-h-[500px] lg:max-h-[600px] w-full flex-col items-stretch justify-between gap-12 md:gap-16 lg:gap-20">
        ...
        <div className="flex flex-row items-center justify-between w-full">
          ...
          <Circle ref={div4Ref} className="size-20 md:size-24 lg:size-28">
            <Icons.openai />
          </Circle>
          <Circle ref={div6Ref}>
            <Icons.zapier />
