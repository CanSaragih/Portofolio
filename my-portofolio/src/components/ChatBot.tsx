    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 z-50 p-4 rounded-full bg-gradient-to-r from-slate-700 to-slate-900 hover:from-slate-600 hover:to-slate-800 transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
        >
      ...
      {/* Chat Box */}
      {isOpen && (
        <div className="fixed bottom-6 right-6 z-50 w-[85vw] max-w-sm bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
          {/* Enhanced Header */}
          ...
          <div
            className={`overflow-y-auto p-4 space-y-3 bg-gradient-to-b from-slate-50/30 to-white ${
          ...
          {/* Enhanced Suggestion Chips - Only show when no messages */}
          {messages.length === 0 && (
            <div className="px-4 pb-3 bg-white h-[80px] flex flex-col justify-center">
          ...
          <div className="p-4 border-t border-slate-100 bg-white h-[76px] flex items-center">
            <form
