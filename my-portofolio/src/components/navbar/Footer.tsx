        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center text-black hover:text-gray-600 transition-transform duration-300 transform hover:-translate-y-1 hover:scale-110"
            >
              <svg
          ...
          >
            ...
            <div className="flex items-center space-x-4">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-black hover:text-gray-600 transition-transform duration-300 transform hover:-translate-y-1 hover:scale-110"
                title="Instagram"
              >
                <svg
                  className="w-6 h-6"
